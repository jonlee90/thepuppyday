 ...
 * Must be wrapped in <Suspense> by the server component parent (page.tsx)
 */
      ...
      <div className="bg-white p-8 rounded-2xl shadow-lg">
        ...
        {message === 'confirm-email' && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            className="flex items-start gap-3 p-4 mb-6 bg-green-50 border border-green-100 rounded-lg"
          >
            <MailCheck className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
