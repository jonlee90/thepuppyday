  ...
  try {
    ...
    const sections: SettingsSectionMetadata[] = [
      ...
      },
      {
        id: 'services',
        title: 'Services',
        description: 'Manage grooming services and size-based pricing',
        href: '/admin/settings/services',
        icon: 'Scissors',
        status: 'configured',
        summary: 'Grooming service catalog',
        lastUpdated: null,
      },
      {
        id: 'addons',
        title: 'Add-ons',
        description: 'Manage add-on services and breed-based upsells',
        href: '/admin/settings/addons',
        icon: 'Plus',
        status: 'configured',
        summary: 'Add-on service options',
        lastUpdated: null,
      },
      {
        id: 'gallery',
        title: 'Gallery',
        description: 'Upload, edit, and organize gallery photos',
        href: '/admin/settings/gallery',
        icon: 'Image',
        status: 'configured',
        summary: 'Public gallery management',
        lastUpdated: null,
      },
      {
        id: 'business-hours',
...
export default async function SettingsPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Page Header */}
      <div>
        <h1 className="hidden lg:block text-3xl font-bold text-[#434E54]">Settings</h1>
