  ...
  (
    ...
    return (
      <motion.button
        ...
        className={cn(
          'inline-flex items-center justify-center font-semibold rounded-xl transition-all cursor-pointer focus:outline-none focus:ring-2 focus:ring-[#434E54]/30 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed',
