...
export function RevenueOverview({ revenueData, loading, error, onRetry }: RevenueOverviewProps) {
  ...
  const cards = [
    ...
    },
    {
      ...
      subtitle: `Completed: ${formatCurrency(thisWeek.completed)}\u00a0\u00a0|\u00a0\u00a0Pending: ${formatCurrency(thisWeek.pending)}`,
    ...
    },
    {
      ...
      subtitle: `Completed: ${formatCurrency(thisMonth.completed)}\u00a0\u00a0|\u00a0\u00a0Pending: ${formatCurrency(thisMonth.pending)}`,
