    ...
    <footer className="bg-[#EAE0D5]">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* About */}
          <div>
            <h3 className="font-semibold text-lg mb-4 text-[#434E54]">Puppy Day</h3>
            <p className="text-[#6B7280] text-sm">
              Professional dog grooming and day care services in La Mirada, CA. We treat your dogs like family.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-[#6B7280]">
              <li>
                <a href="tel:+16572522903" className="hover:text-[#434E54] transition-colors duration-200">
                  (657) 252-2903
                </a>
              </li>
              <li>
                <a href="mailto:puppyday14936@gmail.com" className="hover:text-[#434E54] transition-colors duration-200 break-all">
                  puppyday14936@gmail.com
                </a>
              </li>
              <li>14936 Leffingwell Rd</li>
