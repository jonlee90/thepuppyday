...
- **User Persona:** [Who benefits — admin, customer, groomer]

## 2. Scope
- **In Scope:** [What's included]
- **Out of Scope:** [What's explicitly excluded]
- **Constraints:** [Tech, compliance, business rules]
...
**Tech Hints:** [Specific tables, APIs, components to use — e.g. "Query `appointments` table with RLS", "Use BookingModal in admin mode"]
...
|----|----------|-------------|---------|
| NFR-1 | Performance | Page loads within X seconds | Lighthouse score |
| NFR-2 | Accessibility | WCAG 2.1 AA compliant | axe audit |
...
- **APIs:** [External services involved]
- **Components:** [Existing components to reuse]
````

- The model MUST auto-populate "Tech Hints" for each requirement by reading `CLAUDE.md` and `docs/architecture/ARCHITECTURE.md` to identify relevant database tables, API routes, and existing components
- The model MUST include at least 2 Gherkin scenarios per requirement for complex flows (flows with multiple steps or conditional logic)
- The model MUST generate Non-Functional Requirements (Section 4) when the feature involves UI components, including performance and accessibility criteria
- The model MUST always populate Section 5 (Edge Cases) with at least 3 edge cases
- The model MUST always populate Section 6 (Dependencies) with concrete database tables, APIs, and components from the existing codebase
