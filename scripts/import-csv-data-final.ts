...
// CHANGE 1: Point to final CSV files
const CUSTOMER_CSV = join(__dirname, '..', 'docs/import-files-final/puppyday-customer-pet-import-final.csv');
const APPT_CSV = join(__dirname, '..', 'docs/import-files-final/puppyday-appointments-import-final.csv');
